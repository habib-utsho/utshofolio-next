...
const NavLink = ({ href, children }) => {
    ...
    return (
        <div className='relative group'>
            <Link className={`${isActive? 'bg-gradient-to-tr from-red-500 to-blue-500' : 'bg-gradient-to-t from-[#222831] to-[#000000]'}  py-3 px-5 flex justify-center`} href={href}>{children}</Link>
